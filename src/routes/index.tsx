    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-8">
          <a href="#home" className="flex items-center">
            <img src={logoAsset.url} alt="Sundown Pool Service" className="h-10 w-auto sm:h-12 lg:h-14" />
          </a>
      ...
      <footer className="bg-[#0a2547] text-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:grid-cols-2 lg:grid-cols-5 lg:px-8">
          <div>
            <img src={logoAsset.url} alt="Sundown Pool Service" className="h-12 w-auto brightness-0 invert" />
