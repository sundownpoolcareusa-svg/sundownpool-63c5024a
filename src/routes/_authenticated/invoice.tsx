            ...
            <div className="space-y-2">
              {items.map((it, idx) => (
                <div key={idx} className="grid grid-cols-12 gap-2">
                  ...
                  <textarea rows={4} className="col-span-3 resize-y rounded-[10px] border border-[var(--dash-border-input)] px-3 py-2 text-sm" placeholder="Description (one item per line)" value={it.description} onChange={(e) => { const n = [...items]; n[idx].description = e.target.value; setItems(n); }} />
