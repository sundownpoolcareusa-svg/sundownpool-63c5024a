  ...
  return (
    <footer className="relative overflow-hidden bg-brand-navy font-body text-[#c3d0e6]">
      ...
      <div className="relative mx-auto grid max-w-[1180px] gap-8 px-7 py-14 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1.35fr_1.4fr_1.15fr]">
        <div>
          <img src={logoWhite} alt="Sundown Pool Care" className="mb-4 h-[130px] w-auto" />
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-[13.5px]">
            ...
            <li className="flex items-center gap-2.5 text-[#b4c4de]"><Mail className="h-4 w-4 text-[#7fb6e6]" /> sundownpoolcareusa@gmail.com</li>
            <li className="flex items-center gap-2.5 text-[#b4c4de]"><MapPin className="h-4 w-4 text-[#7fb6e6]" /> Southwest Florida</li>
      ...
      <div className="relative border-t border-white/10">
        <p className="px-5 py-4 text-center text-[12.5px] text-[#8ea1c2]">© 2017-2026 Sundown Pool Care. All Rights Reserved.</p>
      </div>
    </footer>
  );
}
