...
export function ServiceAreasPage() {
  useDocumentTitle(
    "Service Areas — Sundown Pool Care | Sarasota & Surrounding Areas",
    "Professional pool cleaning, green pool cleanup, equipment repair, and weekly maintenance throughout Sarasota County and surrounding areas.",
  );
  return (
