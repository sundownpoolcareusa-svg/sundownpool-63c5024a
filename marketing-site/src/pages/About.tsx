...
export function AboutPage() {
  useDocumentTitle(
    "About Us — Sundown Pool Care | Trusted Pool Care in Southwest Florida",
    "Sundown Pool Care treats every pool like our own. Family-owned, licensed and insured, with years of experience serving homes and businesses across Southwest Florida.",
  );
  return (
